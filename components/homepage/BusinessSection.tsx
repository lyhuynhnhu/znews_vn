    ...
    <>
      {businessNewsKeys.length > 0 &&
        businessNewsKeys.map((item) => {
          const featuredNews = businessNews[item].find(
            (news) => news.size === "large"
          );
          const mediumNews = businessNews[item].filter(
            (news) => news.size === "medium"
          );
          const smallNews = businessNews[item].filter(
            (news) => news.size === "small"
          );
